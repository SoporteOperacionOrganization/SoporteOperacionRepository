...
<jsp:include page="../fragments/header.jsp" />
	<div class="well lead tituloPagina">Modificar usuario</div>
    ...
    <form:form method="POST" modelAttribute="usuario" class="form-horizontal">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-7">
                    <form:input type="password" path="passwordConfirmation" id="passwordConfirmation" name="passwordConfirmation" value="${passwordConfirmation}" class="form-control input-sm" data-toggle="tooltip" title="Debe contener al menos una letra mayúscula, minúsculas, al menos un número, al menos un caracter especial y no debe contener espacios en blanco"/>
                    <div class="has-error errores">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="rol.id">Perfil</label>
                <div class="col-md-7">
                    ...
                    <div class="has-error errores">
                        <form:errors path="rol.id" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div> 	
        ...
        <div class="row">
            <div class="form-actions floatRight">
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="submit" value="Agregar" class="btn btn-primary btn-sm"/> o <a href="<c:url value='/listarUsuarios' />">Cancelar</a>
                    </c:otherwise>
                </c:choose>
            </div>
        </div>
